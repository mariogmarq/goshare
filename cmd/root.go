/*
Copyright © 2020 Mario García Márquez <mariogmarq@gmail.com>
...
//Version of the aplication for -v command
...
func init() {
	...
	rootCmd.AddCommand(versionCmd, sendCmd, getCmd)
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".goshare" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".goshare")
	}
